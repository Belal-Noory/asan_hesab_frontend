    ...
    return (
        <LoadingScreen loading={loader} bgColor="#f1f1f1" spinnerColor="tomato" textColor="#676767" logoSrc="/images/logo-dark.svg" text="در حال بارگیری">
            <div className="datatable-crud-demo" dir="rtl">
                ...
                <Dialog visible={productDialog} style={{ width: "450px" }} header="مشخصات مشتری" modal className="p-fluid text-right" footer={productDialogFooter} onHide={hideDialog}>
                    <div className="field">
                        ...
                        {submitted && !customer.name && <small className="p-error">اسم مشتری ضروری است</small>}
                    </div>
                    <div className="field">
                        ...
                        {submitted && !customer.phone && <small className="p-error">شماره مشتری ضروری است</small>}
                    </div>
                </Dialog>
